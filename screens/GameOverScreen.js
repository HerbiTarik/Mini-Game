...
export default function GameOverScreen({roundsNumber, userNumber, onStartNewGame}) {
  ...
  return (
    ...
    <Image style={styles.image} source={require('../assets/images/bhn.jpg') }/>
    </View>
    ...
    <PrimaryButton style={styles.primaryButton} onPress={onStartNewGame}>Start New Game</PrimaryButton>
    </View>
    </ScrollView>
    )
}
